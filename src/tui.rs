...
use crate::{
    ...
    operations::{
        ...
        InstallTarget, OperationPrompt, StepOutcome, TargetDisposition, UninstallDisposition,
        UninstallPrompt, UninstallStatus,
    },
...
/// updates and repair — are absent by construction.
///
